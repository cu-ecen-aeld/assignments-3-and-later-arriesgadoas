...
void* threadfunc(void* thread_param)
{
    ...
    usleep(1000 * (thread_func_args->_wait_to_obtain_ms));
    ...
    else
    {
        ...
        usleep(1000 * (thread_func_args->_wait_to_release_ms));
...
bool start_thread_obtaining_mutex(pthread_t *thread, pthread_mutex_t *mutex,int wait_to_obtain_ms, int wait_to_release_ms)
{
    ...
    data->_mutex = mutex;
    data->_wait_to_obtain_ms = wait_to_obtain_ms;
    data->_wait_to_release_ms = wait_to_release_ms;
